...
4. **Implementation Sync:** Ensure that any implementation task (backend or frontend) is accompanied by its corresponding documentation update. Documentation is not second-class; it is part of the feature.
